...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'rohan2106kumar@gmail.com', // gmail
...
exports.cookieExtractor = function (req) {
  ...
  // token ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2NGYzMDkxZmFkODhiYjRkZWVlYTA3YSIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcxNjQ2NzYzNn0.ZCJ7RepFqa3nqoeywH0Kcrwb863WQrQTm19y4qEWV0c"
  return token;
};
